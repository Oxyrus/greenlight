...
// User represents an individual user. Importantly, notice how we are using
// the json:"-" struct tag to prevent the Password and Version fields appearing in
...
// otherwise.
func (p *password) Matches(plaintextPassword string) (matches bool, err error) {
...
func ValidateUser(v *validator.Validator, user *User) {
	...
	// If the plaintext password is not nil, call the corresponding helper.
