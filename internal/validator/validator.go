...
// EmailRX is used to declare a regular expression for sanity checking the format of email addresses (we'll
...
// Validator defines a type which contains a map of validation errors
